...
export function EditorChrome({ nodes, rootIds, selected, onSelect, onToggleLock }: { nodes: Record<NodeId, EditorNode>; rootIds: NodeId[]; selected: NodeId | null; onSelect: (id: NodeId) => void; onToggleLock: (id: NodeId) => void }) {
  return <aside className="hidden w-52 shrink-0 flex-col border-r border-border bg-white lg:flex">
