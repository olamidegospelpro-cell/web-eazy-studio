 ...
 *
 * The wizard is pure UI: it collects a draft, validates it with the shared zod
 * schemas, and hands a CreateProjectInput to the store. Nothing is written to
 * disk here; the folder is chosen on the first save.
 */
